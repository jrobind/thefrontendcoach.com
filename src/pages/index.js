  ...
  <div className="landing">
    ...
    <section className="hero bg-main px-3 py-4 md:px-3">
      <div className="wrapper u-px-3 flex md:justify-between justify-center items-center">
        <div className="text-white flex flex-col md:mr-4 max-w-600 md:max-w-75- md:max-w-600">
          <h1 className="text-shadow text-3xl md:text-4xl">The Help You Need To Start Your Career as a Front-End Developer</h1>
        ...
        <img className="img-shadow hidden h-auto md:block" alt="Man inspecting code block" src="./images/web-development.svg" width='450' height='338'/>
      </div>
    </section>
    ...
    <section className="services py-6 md:py-7" style={{backgroundColor: 'rgba(0, 0, 0, 0.025)'}}>
      <div className="wrapper flex-col px-3">
        <div className="flex flex-col mb-5 md:flex-row justify-center">
          <div className="block justify-center flex-col mb-6 md:mb-3 items-center md:mr-7">
            ...
            <div className="text-center flex flex-1 flex-col items-center">
              <h3 className="font-bold font-medium mb-3 text-lg md:text-xl">Support</h3>
        ...
        <div className="rounded p-3 mb-4 shadow-md bg-white mt-6 md:mt-7 bg-blog-blob-landing bg-cover" style={{backgroundPosition: '-488px -271px'}}>
          <div>
            <h2 className="mb-4 m-auto text-2xl md:text-3xl">Latest blog posts</h2>
