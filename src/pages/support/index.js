        ...
        <section className="wrapper px-3 relative" style={{minHeight: '300px'}}>
          <div className="pb-7 flex justify-center">
            <div className="z-1 mt-5 md:mt-7" style={{maxWidth: '500px'}}>
              ...
              <p className="text-lg md:text-xl text-center m-auto">Do you want to become a Front End Developer? Are you stuck? Have no idea where to start? Maybe you're further down the learning pathway and you need a hand with your portfolio? Or CV? Not to worry! Help is on its way - <strong className="font-bold underline">see the support options below.</strong></p>
            </div>
          </div>
          ...
          <div className="wrapper flex flex-col-reverse md:flex-row-reverse space-between items-center">
            <div className="md:ml-5">
              ...
              <ul className="mb-4 text-lg md:text-xl">
                ...
                <li className="pb-2"><span className="bullet mr-1"></span> Find out about the best resources to learn from to save you time and money.</li>
                <li><span className="bullet mr-1"></span> Ask me any questions you may have!</li>
              </ul>
              <a className="btn bg-tertiary text-black">JOIN NOW</a>
            </div>
          ...
          <div className="mb-3 relative flex justify-center md:block">
            <div className="text-lg md:text-xl flex-col flex mt-4md:block md:mt-5" style={{maxWidth: '700px'}}>
              ...
              <ul>
                ...
                <li><span className="bullet mr-1"></span> Your biggest blockers to learning and pursuing your goals at the currrent time.</li>
              </ul>
            </div>
