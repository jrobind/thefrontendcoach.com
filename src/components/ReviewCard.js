export default function ReviewCard() {
  return (
    <div className="mx-3 pb-7 text-center md:flex md:justify-center">
      <div className="card mt-6 mx-3 bg-no-repeat relative mb-5 md:mb-0">
        ...
        <div className="absolute left-0 right-0 m-auto rounded-full img-shadow overflow-hidden m-auto" style={{ width: '80px', height: '80px', top: '-40px'} }>
      ...
      <div className="card mx-3 bg-no-repeat relative" style={{ maxHeight: '345px' }}>
